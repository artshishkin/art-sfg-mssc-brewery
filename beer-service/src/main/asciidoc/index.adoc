= ART Brewery Order Service Docs
Art Shyshkin;
:doctype: book
:icons: font
...
`BeerControllerTest` makes a call to a very simple guru.sfg.beer.inventory.service and produces three
...
include::{snippets}/v1/beer-new/response-headers.adoc[]
